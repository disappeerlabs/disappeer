...
Frame object component containing widgets for root window left panel gpg notebook tab frame
...
class GPGFrame(tkinter.Frame):
    ...
    def __init__(self, parent):
        ...
        self.key_info_dropdown = None
        self.key_info_option_var = None
        self.key_info_button = None
        self.get_key_info_button = None
        self.new_key_button = None
        self.delete_key_button = None
        self.setup()
