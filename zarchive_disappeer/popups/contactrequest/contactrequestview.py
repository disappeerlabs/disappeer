"""
contactrequestview.py

Module for ContactRequestView, view for contact request popup
...
class ContactRequestView:
    ...
    def config_form_buttons(self):
        ...
        self.reject_button = ttk.Button(button_frame, text='Reject')
        self.reject_button.grid(row=1, column=0, sticky=styling.sticky_ew, padx=(0, 5), pady=(5, 5))

        self.accept_button = ttk.Button(button_frame, text='Accept')
        self.accept_button.grid(row=1, column=1, sticky=styling.sticky_ew, padx=(0, 0), pady=(5, 5))
