"""
test_dbreceivedmessagestable.py

Test suite for DBReceivedMessagesTable class object and module
...
class TestImports(unittest.TestCase):
    ...
    def test_basemessagestable(self):
        self.assertEqual(basemessagestable, dbreceivedmessagestable.basemessagestable)
...
class TestClassBasics(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.x = dbreceivedmessagestable.DBPReceivedMessagesTable(self.db_file_path)
    ...
    def test_instance(self):
        self.assertIsInstance(self.x, dbreceivedmessagestable.DBPReceivedMessagesTable)
    ...
    def test_data_row_name_class_attribute(self):
        target = 'ReceivedMessagesTableRow'
